...
- Google Sheets shared data, Google Drive image uploads and approximately 10-second active-device synchronization
...
5. Copy the `/exec` URL into Vercel as `NEXT_PUBLIC_INAM_API_ENDPOINT` for Production, Preview and Development.
6. Redeploy Vercel.
...
- `NEXT_PUBLIC_INAM_API_ENDPOINT`: deployed Apps Script `/exec` URL
